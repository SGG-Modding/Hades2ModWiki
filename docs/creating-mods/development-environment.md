...
:::info[After creating symlinks]
After setting up a symlink, it is strongly recommended to use the manual build method below once to set up the correct folder structure for your mod in the `ReturnOfModding` folder used by r2modman.
:::
